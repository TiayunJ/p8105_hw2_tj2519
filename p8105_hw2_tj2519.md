...
original dataset. It contains 471 participants and it involves 11
variables. Among all the participants, the mean current age is 65.05,
the mean baseline ratio of β42/40 is NA. As the time progress, there are
some N/A values appear, which might indicate that there are some
