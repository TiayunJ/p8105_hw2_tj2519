...
The combinded dataset ad_both contains the participants in both of the original dataset. It contains `r nrow(ad_both)` observations and `r nrow(ad_both) / 5` qualified participants. It involves `r ncol(ad_both)` variables. 
