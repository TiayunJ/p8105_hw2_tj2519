...
print(sapply(gwy_trawh_df, class))
view(gwy_trawh_df) 
```
...
```{r}
trashwheel_comb =
  left_join(trawh_df, prof_trawh_df, by = "dumpster")
trashwheel_comb = 
  left_join(trashwheel_comb, gwy_trawh_df, by = "dumpster")

view(trashwheel_comb)
```
